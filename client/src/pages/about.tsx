              ...
              <div>
                ...
                <dd className="mt-2 text-base text-gray-500">
                  ...
                  <ul className="list-disc pl-5 mt-2 space-y-2">
                    ...
                    <li><span className="font-medium">Analysts</span>: The PlantUML Mapping Tool helps analysts create professional UML diagrams to visualize workflows and system integrations.</li>
