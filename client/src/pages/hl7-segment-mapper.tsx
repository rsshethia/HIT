...
const HL7SegmentMapper: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <Card className="mb-6">
        <CardHeader>
          <CardTitle>HL7 Segment to Message Type Relationship</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Badge variant={filterValue > 0 ? "secondary" : "outline"}>
                ...
                <CardContent>
                  {selectedNode ? (
                    <div className="space-y-4">
                      <div>
                        <Badge variant={selectedNode.type === 'segment' ? 'secondary' : 'default'}>
                      ...
                      {selectedNode.type === 'segment' && (
                        <div>
                          <h4 className="text-sm font-medium mb-2">Used in these message types:</h4>
