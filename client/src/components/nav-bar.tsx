        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden md:ml-6 md:flex md:space-x-6">
              ...
              <Link
                href="/map"
                className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${isActive("/map")
                    ? "border-primary text-gray-900"
                    : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                  }`}
              >
                <span className="lg:hidden">Systems Map</span>
                <span className="hidden lg:inline">Healthcare Systems Map</span>
              </Link>
              <Link
                href="/about"
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden absolute w-full bg-white shadow-lg z-50`}>
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link
            href="/map"
            onClick={() => setIsMenuOpen(false)}
            className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium ${isActive("/map")
                ? "border-primary text-primary bg-primary-50"
                : "border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700"
              }`}
          >
            Healthcare Systems Map
          </Link>
          <Link
            href="/about"
            onClick={() => setIsMenuOpen(false)}
